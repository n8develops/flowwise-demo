export const translations = {
  en: {
    ...
    goalSetting: {
      ...
      greeting: "Great! Your bank is connected. Now let's set up a goal that works for you.",
      askPriority: "What's most important to you right now?",
      priorityEmergency: "Emergency fund",
      priorityDebt: "Pay off debt",
      prioritySave: "Save for something",
      priorityWealth: "Build wealth",
      followUp: "Perfect! How much would you like to save each week?",
      generating: "Creating your personalized plan...",
      goalCreated: "✅ Perfect! I've set up your {goal} goal. Your target is ${amount}. Let's get started!",
  ...
  es: {
    ...
    goalSetting: {
      ...
      greeting: "¡Genial! Tu banco está conectado. Ahora configuremos una meta que funcione para ti.",
      askPriority: "¿Qué es lo más importante para ti ahora?",
      priorityEmergency: "Fondo de emergencia",
      priorityDebt: "Pagar deuda",
      prioritySave: "Ahorrar para algo",
      priorityWealth: "Construir riqueza",
      followUp: "¡Perfecto! ¿Cuánto te gustaría ahorrar cada semana?",
      generating: "Creando tu plan personalizado...",
      goalCreated: "✅ ¡Perfecto! He configurado tu meta de {goal}. Tu objetivo es ${amount}. ¡Empecemos!",
